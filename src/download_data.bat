curl -o ..\src_data\weapon_attribute_attack_power_map.csv -L "https://docs.google.com/spreadsheets/d/1ybiI1WgyRs67kGklUXeroi58KDab2KsU_hKutBORiW0/export?gid=1749106382&format=csv"
...
curl -o ..\src_data\swing_values.csv -L "https://docs.google.com/spreadsheets/d/1j4bpTbsnp5Xsgw9TP2xv6d8R4qk0ErpE9r_5LGIDraU/export?gid=506566839&format=csv"

curl -o ..\src_data\bosses.csv -L "https://docs.google.com/spreadsheets/d/1aujq95UfL_oUs3voPt3nGqM1hLhaVJOj6JKB6Np3FD8/export?gid=1466577964&format=csv"
curl -o ..\src_data\difficulty_scaling.csv -L "https://docs.google.com/spreadsheets/d/1aujq95UfL_oUs3voPt3nGqM1hLhaVJOj6JKB6Np3FD8/export?gid=466524610&format=csv"